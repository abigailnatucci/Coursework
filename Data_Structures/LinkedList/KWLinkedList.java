...
Assignment: Lab05
Sources consulted: ListIterator Documentation, Textbook 2.6-2.8, Java LinkedList Documentation
*/
...
public class KWLinkedList<E> extends AbstractSequentialList<E> {
    ...
    private class KWListIter implements ListIterator<E> {
        ...
        public boolean hasPrevious() {
            ...
            /* The author's version is below.  What's wrong with this one?
            * If you are one of the first three people to email me the answer
            * before 9:55 AM Tuesday, I will give you 5 homework bonus points.
    ...
    public int lastIndexOf(Object target) {
        ...
        while (iter.hasPrevious()) {
            if (iter.previous().equals(target)) {
